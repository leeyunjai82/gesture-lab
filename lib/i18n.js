...
const GL_I18N = {
  // ── 페이지 / 헤더 ──
  '제스처 랩': 'Gesture Lab',
  '제스처 랩 — 학습실': 'Gesture Lab — Teach',
  '제스처 랩 — 시험실': 'Gesture Lab — Test',
  '제스처 랩 — 보관함': 'Gesture Lab — Models',
  '학습실': 'Teach',
  '시험실': 'Test',
  '보관함': 'Models',
  '준비 중…': 'Getting ready…',
  ...
  '무엇을 보고 배울지 골라요.\n손, 얼굴, 포즈 중 하나!': 'Pick what to watch.\nHand, face, or body!',
