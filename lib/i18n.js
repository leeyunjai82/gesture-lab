...
const GL_I18N = {
  // ── 페이지 / 헤더 ──
  '제스처 랩': 'Gesture Lab',
  '제스처 랩 — 학습실': 'Gesture Lab — Teach Room',
  '제스처 랩 — 시험실': 'Gesture Lab — Test Room',
  '제스처 랩 — 보관함': 'Gesture Lab — My Models',
  '학습실': 'Teach Room',
  '시험실': 'Test Room',
  '보관함': 'My Models',
  '준비 중…': 'Getting ready…',
  ...
  '에서 만들어 보세요.': 'is where you can make one.',
  '보는 것마다 모델을 골라요. 최대 3개예요.': 'Pick a model for each source. Up to 3.',
  '사용 안 해요': 'Not used',
  '확신 정도': 'How sure',
  '이보다 덜 확실하면 "모르겠어요"라고 답해요.': 'Below this, the AI says "Not sure".',
  'AI의 답': "AI's answer",
  ...
  '규칙 더하기': 'Add a rule',
  '동작 이름 (예: 발사!)': 'Action name (e.g. Fire!)',
  '상관없어요': "Don't care",
  ...
  // ── 출력 장치 (LED / 말하기) ──
  '출력 장치': 'Outputs',
  '답이 나오면 여기가 움직여요': 'This reacts when the AI answers',
  '반응 만들기': 'Make reactions',
  '답이 나오면 불을 켜고 말을 해요.': 'When the AI answers, light up and speak.',
  '말할 말 (예: 안녕!)': 'Words to say (e.g. Hi!)',
  '말할 말 (예: 발사!)': 'Words to say (e.g. Fire!)',
  '반응': 'React',
  '말하기': 'Speak',
  '불 끄기': 'Light off',
  '빨강': 'Red',
