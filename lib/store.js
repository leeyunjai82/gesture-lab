...
// ═══════════════════════════════════════════════════════════
//  · 모델 가중치  : model.save('indexeddb://gesturelab-{name}')  (tf.js 내장)
//  · 메타데이터   : IndexedDB 'gesture-lab' / 스토어 'meta' (keyPath: name)
//  · 원본 이미지는 저장하지 않는다. (용량·프라이버시)
//
// 메타데이터 형식 (version 1):
//  { name, source, featureDim, classes, sampleCount, accuracy, createdAt, version }

const DB_NAME = 'gesture-lab', META = 'meta', VER = 1;
const MODEL_PREFIX = 'indexeddb://gesturelab-';
